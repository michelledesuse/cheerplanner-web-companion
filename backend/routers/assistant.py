...
APP_GUIDE = (
    ...
    "chat), Team Chat (pin important messages), Scouting Reports (skill library by Level 1-7 — "
    "Tumbling is split into Standing and Running sub-groups — where coaches tap a skill and set an "
    "athlete's progression level; use 'Select' to set several at once), Calendar (team events with "
    "family RSVPs; families tap 'Add to my calendar' to copy an event into their personal Schedule), "
    "Competition Results, Team Forms, Roster, and SMS Broadcast.\n\n"
