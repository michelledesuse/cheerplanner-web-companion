...
async def opt_in_proof():
    ...
    return HTMLResponse(
        ...
        '<div style="font-weight:800;color:#E11D48;font-size:20px;margin-bottom:6px">CheerPlanner</div>'
        ...
        '<div style="width:44px;height:26px;border-radius:13px;background:#E11D48;position:relative;flex:none">'
        '<div style="position:absolute;top:3px;right:3px;width:20px;height:20px;border-radius:10px;background:#fff"></div></div>'
        '</div></div>'
