...
const makeStyles = (c: ThemePalette) => ({
  ...
  cta: { backgroundColor: c.accent, borderRadius: radius.md, paddingVertical: 12, alignItems: "center" },
  ctaText: { color: "white", fontWeight: "700" },
  smallBtn: { backgroundColor: c.accent, borderRadius: radius.md, paddingHorizontal: 14, paddingVertical: 10, alignItems: "center", justifyContent: "center" },
