  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      <ScrollView contentContainerStyle={{ padding: spacing.lg, paddingBottom: 120 }} testID="settings-screen">
        ...
        <Text style={styles.sectionHead}>TeamHub</Text>
        <View style={styles.group}>
          <SettingRow label="TeamHub Access" subtitle="Grant access, or enter a TeamHub code from a coach/gym" onPress={() => router.push("/team-access" as any)} chevron testID="settings-team-access" />
        </View>
