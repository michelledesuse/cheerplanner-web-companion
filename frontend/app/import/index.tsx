...
const makeStyles = () => ({
  ...
  fmtChipOn: { backgroundColor: colors.accent },
  ...
  primaryBtn: { flexDirection: "row", alignItems: "center", gap: 6, backgroundColor: colors.accent, paddingHorizontal: 14, paddingVertical: 9, borderRadius: 10 },
