...
const makeStyles = (c: ThemePalette) => ({
  ...
  inputMulti: { minHeight: 72, maxHeight: 160, textAlignVertical: "top" },
  ...
  remindInput: { backgroundColor: c.bg, borderWidth: 1, borderColor: c.border, borderRadius: radius.md, padding: 12, minHeight: 90, maxHeight: 180, textAlignVertical: "top", ...typography.body, color: c.textPrimary },
