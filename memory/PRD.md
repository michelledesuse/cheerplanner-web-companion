...
- Config: backend/.env GEMINI_API_KEY=AQ.Ab8RN6Jeomca0reB9rB0d7_H2h9jhERjZzQr4NQmzFdgAVkLcw, IMAGEN_MODEL=imagen-4.0-fast-generate-001, GEMINI_IMAGE_MODEL=gemini-2.5-flash-image (fallback).
...
- Config: backend/.env OPENAI_API_KEY=<user's own sk-proj-... key>. GPT-Image-2 confirmed working live on the user's key (org verification was 'in process' but generation succeeds).
